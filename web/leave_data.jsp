...
<html>
  <head>
    ...
    <title>Leave Applications - DeskSavvy</title>
    ...
    <style>
      ...
      *, *::before, *::after { box-sizing: border-box; margin: 0; padding: 0; }
      ...
      .action-link { color: var(--red); text-decoration: none; font-weight: 600; font-size: 13px; display: inline-flex; align-items: center; gap: 6px; padding: 6px 12px; border-radius: 6px; transition: all .2s; }
      .action-link:hover { background: rgba(255, 71, 87, 0.1); }
  ...
  <body>
    ...
    <aside class="sidebar">
      ...
      <nav class="nav-menu">
        ...
        <a href="leave_data.jsp" class="nav-item active"><i class="fas fa-calendar-minus"></i> View Leave</a>
    ...
    <main class="main-content">
      ...
      <div class="dashboard-body">
        ...
        <h1 class="page-title animate-1">Leave Applications</h1>
        <p class="page-subtitle animate-1">Review and manage leave requests submitted by staff members.</p>
          ...
          <table class="modern-table">
            ...
            <tbody>
              <%
                ...
                while(db.rst.next()) {
                  String recordId = db.rst.getString(1);
                  String empId = db.rst.getString(3);
                  String subject = db.rst.getString(4);
                  String message = db.rst.getString(5);
                  String applyDate = db.rst.getString(6);
              %>
              <tr>
                <td><strong><%= empId %></strong></td>
                <td><%= subject %></td>
                <td><span style="color: #666; font-size: 13.5px;"><%= message %></span></td>
                <td><%= applyDate %></td>
                <td>
                  <a href="delete?id=<%= recordId %>" class="action-link" onclick="return confirm('Are you sure you want to delete this application?')">
